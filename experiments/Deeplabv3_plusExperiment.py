...
from utils.volume_stats import Dice3d, Jaccard3d, Precision3d, F13d, Recall3d, PValue3d, Specificity3d, Accuracy3d, AUC3d
...
from inference.DeepLabv3inferenceAgent import DeepLabV3PlusInferenceAgent

class DeepLabV3PlusExperiment:
    ...
    def run_test(self):
        print("Testing:")
        self.model.eval()
        inference_agent = DeepLabV3PlusInferenceAgent(model=self.model, device=self.device)
        out_dict = {}
    ...
    def run(self):
        ...
        print("Training for DeepLabV3 Plus has commenced:")
