...
class UnetSkipConnectionBlock(nn.Module):
    def __init__(self, in_channels=None, out_channels=None, num_classes=1, kernel_size=3,
        ...
        use_dropout=False):
            ...
            conv2 = self.contract(in_channels=in_channels, out_channels=out_channels, kernel_size=kernel_size, norm_layer=norm_layer)

            conv3 = self.expand(in_channels=in_channels*2, out_channels=out_channels, kernel_size=kernel_size)
            conv4 = self.expand(in_channels=in_channels, out_channels=out_channels, kernel_size=kernel_size)
    ...
    @staticmethod
    def contract(in_channels, out_channels, kernel_size=2, norm_layer=nn.InstanceNorm2d):
        layer = nn.Sequential(
